# HouseHold_Power_Electric_consupmtion
this is a simple project applyig deep learrning on time_series data using LTSM

the dataset (Individual household electric power consumption Data Set) can be found and downloaded from:
